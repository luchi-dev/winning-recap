...
%AWS% s3 sync . %BUCKET%/ --profile iloveneuquen --cache-control "no-cache" ^
  ...
  --exclude "captions/x-*" --exclude "captions/ig-*" --exclude "captions/auto-*" --exclude "fotos-partido/_*" --exclude "fotos/_*" --exclude "fotos/README.md" --exclude "fotos/revisar.html" --exclude "*/.gitignore"
if errorlevel 1 goto error
